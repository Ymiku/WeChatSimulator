...
public static class Utils
{
    ...
    public static Vector2 CalSpriteDisplaySize(Vector2 spriteSize, Vector2 maxSize)
    {
        if (spriteSize.x * 100.0f < maxSize.x && spriteSize.y * 100.0f < maxSize.y)
            return spriteSize * 100.0f;
