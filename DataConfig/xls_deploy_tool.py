...
class SheetInterpreter:
    ...
    def __init__(self, xls_file_path, sheet_name):
        ...
        self._pb_file_name = "static_data_" + sheet_name.lower() + ".proto"
    ...
    def Interpreter(self) :
        ...
        self._output.append("package static_data;\n")
...
class DataParser:
    ...
    def __init__(self, xls_file_path, sheet_name):
        ...
        try:
            self._module_name = "static_data_" + self._sheet_name.lower() + "_pb2"
    ...
    def _WriteData2File(self, data) :
        file_name = "static_data_" + self._sheet_name.lower() + ".data"
        file = open(file_name, 'wb+')
        file.write(data)
        file.close()

    def _WriteReadableData2File(self, data) :
        file_name = "static_data_" + self._sheet_name.lower() + ".txt"
        file = open(file_name, 'wb+')
        file.write(data)
        file.close()
